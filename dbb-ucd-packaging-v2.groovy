...
/**
 * NJL Mod 03-21-2021 - Jenkins Support. Add coded to find json file in with generate buildLabel
 * +++++++++++++++++++
 *  
...
//see dbb api https://www.ibm.com/support/knowledgecenter/SS6T76_1.1.0/javadoc/index.html?view=embed
def executes= buildReport.getRecords().findAll{
	try {
